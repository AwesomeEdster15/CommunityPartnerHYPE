<?php require "../sharedParts/header.php"; ?>
  ...
  <div class="main">
    ...
    <div class="section1">
      <div>
        <h1 class="title">About Capable Kids And Families®</h1>
        <p>
          Families of children with developmental delays and disabilities often report experiencing isolation, exclusion, financial hardships, insurance restrictions and difficulty accessing treatment, services, and resources.
          Capable Kids and Families® works to increase children’s developmental gains while supporting the family with the appropriate resources and connections.
        </p>
        <p>
